...
FINAL_IMAGE=${DISTDIR}/Display_mux.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/Display_mux.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
