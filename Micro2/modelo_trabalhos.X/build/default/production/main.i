...
_Bool leitura_botao_pressed(char select);
_Bool leitura_botao_click(char select);
...
void setup_bottons(_Bool botao3, _Bool botao4, _Bool botao5);
# 44 "main.c" 2
...
{
    show_lcd();
    show_display_10bits(read_AD_10bits(1));
}
